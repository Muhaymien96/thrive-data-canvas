  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Business Portfolio Overview</h1>
          <p className="text-slate-600 mt-1">Executive dashboard for business performance</p>
        </div>
        <div className="text-right">
          <p className="text-sm text-slate-600">Total Monthly Revenue</p>
          <p className="text-2xl font-bold text-slate-900">R{totalRevenue.toLocaleString()}</p>
        </div>
      </div>
